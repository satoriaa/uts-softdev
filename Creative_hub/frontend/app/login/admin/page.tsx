...
export default function AdminLoginPage() {
  ...
  const [showPassword, setShowPassword] = useState(false); // 👁️ state baru
            ...
            <div className="mb-2">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full p-3.5 pr-12 rounded-lg border border-gray-200 text-black focus:outline-none focus:ring-1 focus:ring-gray-300 transition-colors"
                  value={password}
                ...
                {/* ICON MATA */}
                <button
                  type="button" // penting biar tidak submit
