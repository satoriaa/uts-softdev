...
const { getAll, getById, create, update, remove, finish, getByRuang, getTopPendingPriority } = require('../controllers/pinjamanController');
const { acknowledge } = require('../controllers/pinjamanController');

router.get('/', protect, getAll);
router.get('/ruang/:ruangId', protect, getByRuang);
router.get('/priority', protect, getTopPendingPriority);
